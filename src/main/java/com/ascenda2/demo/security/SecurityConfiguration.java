package com.ascenda2.demo.security;


import com.ascenda2.demo.repository.UserRepository;
import com.ascenda2.demo.service.SSUserDetailsService;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests()
                ...
                .antMatchers("/admin").access("hasAuthority('ADMIN')") //criação de access admin
